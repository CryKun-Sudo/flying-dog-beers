...
@app.callback([Output('table2','data'),Output('table2','columns')],
			  ...
			  [State('output-confirm', 'children'),State('output-confirm_mod','children'),State('output-confirm_del','children'),State('output_save_fdc','children')])
def filter_table2(artikel_selector,artikel_values,children,children_mod,children_del,children_state,children_mod_state,children_del_state,out_put_save_fdc_state):
